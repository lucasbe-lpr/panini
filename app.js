...
/** Collection parsée de l'ami (Map: id → entry) pour les échanges */
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    initBoosterModal();
    initMatchmaker();
    initExchangeActions(); // Nouveau : boutons d'échange
...
/* ═══════════════════════════════════════════════════════════════
   11. EXPORT TEXTE (wantlist / tradelist)
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   15. BARRE DE PROGRESSION GLOBALE
   ═══════════════════════════════════════════════════════════════ */
...
function initGlobalSearch() {
  ...
  input.addEventListener('input', () => {
    ...
    // Dès qu'une recherche démarre, on bascule sur la vue Album
    // pour que les résultats soient visibles, même si on est sur une autre vue.
    if (searchActive && !wasActive && currentView !== 'album') {
      switchView('album');
      // switchView appelle déjà applySearchFilter()
      return;
    }
 ...
 * Sur les vues grille (album), filtre directement les cartes.
 * Sur les vues liste, re-rend avec filtrage.
 * La vue "pays" a été supprimée.
 */
function applySearchFilter() {
  ...
  if (currentView === 'album') {
    ...
    // Pour les autres vues, on affiche une grille globale (album par défaut)
    renderSearchResultsGrid(matched, q);
  }
}
...
/* ═══════════════════════════════════════════════════════════════
   19. MATCHMAKER — REFONTE DES ÉCHANGES
   ═══════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════
   20. GESTION DES ÉVÉNEMENTS DES NOUVEAUX BOUTONS D'ÉCHANGE
   ═══════════════════════════════════════════════════════════════ */
